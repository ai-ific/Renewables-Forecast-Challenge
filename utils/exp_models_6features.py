...
if __name__ == "__main__":
    ...
    '''
    4th Experiment. Model with 6 features
    ...
    rmse_df = deep_learning.run_experiment(model, Xtr, Ytr, Xte, Yte,
                   ...
                   scaler = scaler, 
                   verbose = True)
    result_filenames.append('model_6f_12_shuffle.csv')
    rmse_df.to_csv(result_filenames[-1], index=False)
    
    '''
    5th Experiment. Model with 6 features II
    Input: Energy demand of 3 previous hours to hour t
    Output: Energy demand of hour t
    ...
    rmse_df = deep_learning.run_experiment(model, Xtr, Ytr, Xte, Yte,
                   ...
                   scaler = scaler, 
                   verbose = True)
    result_filenames.append('model_6f_50_shuffle.csv')
    rmse_df.to_csv(result_filenames[-1], index=False)
    
    '''
    3rd Experiment. Model with 6 features III
    Input: Energy demand of 3 previous hours to hour t
    Output: Energy demand of hour t
    ...
    rmse_df = deep_learning.run_experiment(model, Xtr, Ytr, Xte, Yte,
                   ...
                   scaler = scaler, 
                   verbose = True)
    result_filenames.append('model_6f_50_10_shuffle.csv')
    rmse_df.to_csv(result_filenames[-1], index=False)
